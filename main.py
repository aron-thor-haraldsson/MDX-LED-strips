...
# and filling in their default values
...
# This is the heart of the program, allowing any complicated movement
# of an imaginary "wall" of light to pass through the LEDs
# from various angles.
...
# This performs a set animation displaying fade
def perform_fade():
    for n in range(1000):
