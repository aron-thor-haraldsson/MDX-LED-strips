...
#this file contains the function hls1_to_rgb255
#it converts HLS (Hue/Lightness/Saturation) color format to RGB (Red/Green/Blue)

#uses the hls_to_rgb function imported from colorsys
